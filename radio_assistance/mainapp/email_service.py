...
Supports:
- Resend - recommended, simple API key auth
...
RESEND_FROM_NAME = os.getenv("RESEND_FROM_NAME", "Radiology AI Assistant")
...
class ResendService:
    ...
    def send_email(self, to_email: str, subject: str, html_content: str, text_content: Optional[str] = None) -> Dict:
        ...
        if not self._is_configured:
            return {"success": False, "message": "Resend not configured - set RESEND_API_KEY"}
...
class EmailService:
    """Unified email service - uses Resend or SMTP based on config."""
    ...
    def __init__(self):
        ...
        if RESEND_API_KEY:
            ...
            print("[EMAIL] Not configured - set RESEND_API_KEY or SMTP credentials")
    ...
    def _send_email(self, to_email: str, subject: str, html_content: str, text_content: Optional[str] = None) -> Dict:
        ...
        if not self._is_configured:
            ...
            return {"success": False, "message": "Email not configured. Set RESEND_API_KEY in your .env file."}
...
def test_resend_setup():
    ...
    Run: python -m radio_assistance.mainapp.email_service
    """
    print("=" * 60)
    ...
    if not RESEND_API_KEY:
        ...
        print()
        print("Steps to configure Resend:")
        print("1. Sign up at: https://resend.com/")
        print("2. Go to: API Keys")
        print("3. Create a new API key")
        print("4. Add to your .env file:")
        print()
        print("   RESEND_API_KEY=re_your-api-key-here")
        print("   RESEND_FROM_EMAIL=onboarding@resend.dev")
        print("   RESEND_FROM_NAME=Radiology AI Assistant")
        print()
        print("Note: For production, add and verify your domain in Resend dashboard")
        print()
        return
    ...
    if test == 'y':
        ...
        result = resend.send_email(
            ...
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
                <h1 style="color: #2c5282;">🏥 It works!</h1>
                <p>Resend email service is configured correctly.</p>
                <p style="color: #718096; font-size: 12px;">Sent from Radiology AI Assistant</p>
            </div>
            """,
            text_content="It works! Resend email service is configured correctly."
        )
